...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        commission1.setEmpName("Moxy Tan");
        commission1.setTotalSale(80000);

        CommissionEmployee commission2
                = new CommissionEmployee(302, "Luna Snow", 150000);
        ...
        basePlus1.setEmpName("Eduardo Macs");
        basePlus1.setTotalSale(60000);
        basePlus1.setBaseSalary(10000);

        BasePlusCommissionEmployee basePlus2
                = new BasePlusCommissionEmployee(
                        402, "Finn Lionheart", 120000, 15000
                );
