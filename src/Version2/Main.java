...
public class Main {
    public static void main(String[] args) {
        ...
        hourly2.setEmpName(new Name("Bob", "Cruz", "Jones", "Jr."));
        hourly2.setBirthDate(new MyDate(5, 3, 1998));
        hourly2.setDateHired(new MyDate(15, 1, 2021));
        ...
        PieceWorkerEmployee piece1 = new PieceWorkerEmployee(201,
                new Name("Carlos", "Reyes", "Dela Cruz"),
                new MyDate(10, 11, 1995),
                new MyDate(3, 4, 2019),
                250, 8.00);

        PieceWorkerEmployee piece2 = new PieceWorkerEmployee();
        piece2.setEmpId(202);
        piece2.setEmpName(new Name("Diana", "Lopez"));
        piece2.setBirthDate(new MyDate(22, 7, 1992));
        piece2.setDateHired(new MyDate(9, 9, 2020));
        ...
        CommissionEmployee comm1 = new CommissionEmployee(301,
                new Name("Elena", "Torres", "Ramos"),
                new MyDate(2, 12, 1990),
                new MyDate(20, 5, 2018),
                120000.00);

        CommissionEmployee comm2 = new CommissionEmployee();
        comm2.setEmpId(302);
        comm2.setEmpName(new Name("Franco", "Bautista"));
        comm2.setBirthDate(new MyDate(14, 6, 1988));
        comm2.setDateHired(new MyDate(1, 2, 2017));
        ...
        BasePlusCommissionEmployee bpc1 = new BasePlusCommissionEmployee(401,
                new Name("Grace", "Villanueva", "Santos"),
                new MyDate(30, 4, 1993),
                new MyDate(12, 8, 2020),
                550000.00, 10000.00);

        BasePlusCommissionEmployee bpc2 = new BasePlusCommissionEmployee();
        bpc2.setEmpId(402);
        bpc2.setEmpName(new Name("Henry", "Garcia"));
        bpc2.setBirthDate(new MyDate(19, 10, 1991));
